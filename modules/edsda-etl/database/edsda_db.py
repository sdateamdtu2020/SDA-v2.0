...
create_table_queries = [DimArea_Table_Create,DimCity_Table_Create, DimDistrict_Table_Create,  DimYear_Table_Create, 
...
dimensions_insert_queries = [DimYear_table_insert, update_year_staging_tables, DimArea_table_insert, DimCity_table_insert, DimDistrict_table_insert
    , insert_fact_tables]
