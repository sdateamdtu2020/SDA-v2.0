...
BAC_TRUNG_BO = ['Thanh Hóa', 'Nghệ An', 'Hà Tĩnh', 'Quảng Bình', 'Quảng Trị', 'Bắc Trung Bộ và Duyên hải miền Trung']
NAM_TRUNG_BO = ['Thừa Thiên Huế', 'Đà Nẵng', 'Huế', 'Quảng Nam', 'Quảng Ngãi', 'Bình Định', 'Phú Yên', 'Khánh Hòa', 'Kon Tum', 'Gia Lai', 'Đắk Lắk', 'Đắk Nông', 'Đà Lạt', 'Vũng Tàu']
...
def time_generator():
    ...
    quarters = ['quarter 1', 'quater 2', 'quarter 3', 'quarter 4']
